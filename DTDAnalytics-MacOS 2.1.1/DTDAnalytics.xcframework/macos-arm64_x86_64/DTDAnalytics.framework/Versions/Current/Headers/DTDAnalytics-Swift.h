...
///
+ (void)adImpressionWithNetwork:(NSString * _Nonnull)network revenue:(double)revenue source:(NSString * _Nullable)source placement:(NSString * _Nullable)placement unit:(NSString * _Nullable)unit;
@end
...
/// Get User cheater
+ (void)getCheaterHandler:(void (^ _Nonnull)(BOOL))completionHandler;
